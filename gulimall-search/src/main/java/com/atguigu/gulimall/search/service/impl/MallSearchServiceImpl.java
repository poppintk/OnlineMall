...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchResult buildSearchResult(SearchParam param, SearchResponse response) {
        ...
        List<SearchResult.CatalogVo> catelogVos = catelog_agg.getBuckets().stream().map(item -> {
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        //分页
        searchSourceBuilder.from((param.getPageNum() == null ? 0 :  param.getPageNum() - 1) * EsConstant.PRODUCT_PAGESIZE);
